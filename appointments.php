        ...
        <div class="col-lg-4 col-md-4">
          <div class="row">
            <div class="single-top-feature">
              ...
              <ul class="opening-table">
                <li>
                  <a href="<?php echo $row['Report']?>" target="_blank">Download</a>
                </li>
                <li>
                  <a href="deletetestapp.php?id=<?php echo $row['Id']; ?>">Delete Appointment</a>
                </li>
              </ul>   
               <?php
						}
        ...
        <div class="col-lg-4 col-md-4">
          <div class="row">
            <div class="single-top-feature">
              ...
              <ul class="opening-table">
                <li>
                  <a>Rejected by Doctor</a>
                </li>
                <li>
                  <a href="deletedocapp1.php?id=<?php echo $row['Id']; ?>">Delete Appointment</a>
                </li>
              </ul>
              <?php
              }
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
          ...
          ?>
              <ul class="opening-table">
                <li>
                  <a href="deletedocapp.php?id=<?php echo $row['Id']; ?>">Delete</a>
                </li>
                <li>&nbsp;</li>
              </ul>   
               <?php
