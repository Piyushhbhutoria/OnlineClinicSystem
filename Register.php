                      ...
                      <div class="appointment-area">
                        <form class="appointment-form" action="Registration.php" method="post">
                          ...
                          <div class="col-md-6 col-sm-6">
                              ...
                              <input type="email" class="wp-form-control wpcf7-email" placeholder="Email address" name="mail" required>  
                            </div>
							</div>
                          <div class="row">
                            <div class="col-md-6 col-sm-6">
                          ...
                          <div class="row">
                          <div class="col-md-6 col-sm-6">
                              <label class="control-label">Select Gender <span class="required">*</span>
                              </label>
