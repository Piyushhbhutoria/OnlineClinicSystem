                                ...
                                <form class="appointment-form" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6">
                                            ...
                                            <input type="text" class="wp-form-control wpcf7-text"
                                                   placeholder="Last name" name="lname" value="<?= $lname ?>"
                                                   required
                                                   pattern="[A-Za-z-0-9]+">
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            ...
                                            <input type="email" class="wp-form-control wpcf7-text"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            ...
                                            <input type="password" class="wp-form-control wpcf7-text"
                                                   placeholder="Password" name="pwd" value="<?= $pwd ?>"
                                                   required>
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                    </div>
