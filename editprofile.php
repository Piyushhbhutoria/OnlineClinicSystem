                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            ...
                                            <input type="text" class="wp-form-control wpcf7-text"
                                                   value="<?php echo $_SESSION['log']['Name'] ?>" name="name"
                                                   required>
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            ...
                                            <input type="email" class="wp-form-control wpcf7-email"
                                                   value="<?php echo $_SESSION['log']['Email'] ?>" name="mail"
                                                   required>
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            ...
                                            <input type="text" class="wp-form-control wpcf7-email"
                                                   value="<?php echo $_SESSION['log']['Address'] ?>" name="addr"
                                                   required>
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            ...
                                            <input type="number" class="wp-form-control wpcf7-text"
                                                   value="<?php echo $_SESSION['log']['Phone'] ?>" name="phno"
                                                   required>
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            <label class="control-label">Password <span
                                                    class="required">*</span></label>
                                            <input type="password" class="wp-form-control wpcf7-text"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            <label class="control-label">Retype Password <span
                                                    class="required">*</span></label>
                                            <input type="password" class="wp-form-control wpcf7-text"
                                                   placeholder="Retype Password" name="repwd"
                                                   required>
                                        </div>
                                        <div class="col-lg-2 col-md-2"></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6">
                                            <button class="wpcf7-submit button--itzel" name="okpass" type="submit">
                                                <i class="button__icon fa fa-share"></i><span>Change Password</span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
